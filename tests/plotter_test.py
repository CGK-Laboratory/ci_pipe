...
class TestPlotter(CIPipeTestCase):
    ...
    def test_02_get_step_info_nonexistent_step(self):
        # When
        self.plotter.get_step_info(self.trace, step_number=99)
        # Then
        out = self.get_clean_output()
    ...
    def test_03_get_all_trace_from_branch_existing_branch(self):
        # When
        self.plotter.get_all_trace_from_branch(self.trace, branch="Main Branch")
        # Then
        out = self.get_clean_output()
    ...
    def test_04_get_all_trace_from_branch_nonexistent_branch(self):
        # When
        self.plotter.get_all_trace_from_branch(self.trace, branch="NonExistent")
        # Then
        out = self.get_clean_output()
    ...
    def test_05_info_displays_step_with_tracebuilder(self):
        ...
        # When
        pipeline = CIPipe(inputs=pipeline_input, trace_builder=self._trace_builder, file_system=self._file_system,
